...
# VPNMON-R2 v2.33b2 (VPNMON-R2.SH) is an all-in-one script that is optimized for NordVPN, SurfShark VPN and Perfect Privacy
...
# -------------------------------------------------------------------------------------------------------------------------
Version="2.33b2"                                    # Current version of VPNMON-R2
...
lockcheck () {
  ...
  while [ $WAN1Override == "0" ] && [ $WAN0PrimaryCheck -eq 0 ]
    do
      ...
      PrimaryWAN0Check=$($timeoutcmd$timeoutsec nvram get wan0_primary)
