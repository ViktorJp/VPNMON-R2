...
# VPNMON-R2 v2.36b1 (VPNMON-R2.SH) is an all-in-one script that is optimized for NordVPN, SurfShark VPN and Perfect Privacy
...
# -------------------------------------------------------------------------------------------------------------------------
Version="2.36b1"                                    # Current version of VPNMON-R2
...
lockcheck () {
  ...
  if [ "$StopLockFound" == "1" ]; then
    ...
    SPIN=5
    echo ""
    echo -e "${CGreen} Attempting restart of last known good VPN client and restarting UI...${CClear}\n"
