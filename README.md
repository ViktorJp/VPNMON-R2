# VPNMON-R2
VPNMON-R2 v2.11 - Asus-Merlin VPN Health Monitor by Viktor Jaep, 2022
...
1. Download and install directly from AMTM, or using your favorite SSH tools, copy & paste this command:
   ``curl --retry 3 "https://raw.githubusercontent.com/ViktorJp/VPNMON-R2/master/vpnmon-r2-2.11.sh" -o "/jffs/scripts/vpnmon-r2.sh" && chmod a+rx "/jffs/scripts/vpnmon-r2.sh"``
