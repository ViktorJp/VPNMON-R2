...
# VPNMON-R2 v2.55b1 (VPNMON-R2.SH) is an all-in-one script that is optimized for NordVPN, SurfShark VPN and Perfect Privacy
...
# -------------------------------------------------------------------------------------------------------------------------
Version="2.55b1"                                    # Current version of VPNMON-R2
            ...
            # Execute chosen selections
                case "$ConfigSelection" in
                  ...
                  17) # -----------------------------------------------------------------------------------------
                     ...
                     echo -e "${CCyan} utility installed (via AMTM), and must be functional."
                     echo -e "${CYellow} (No=0, Yes=1) (Default = 0)${CClear}"
