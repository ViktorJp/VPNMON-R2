...
# VPNMON-R2 v2.55b4 (VPNMON-R2.SH) is an all-in-one script that is optimized for NordVPN, SurfShark VPN and Perfect Privacy
...
# -------------------------------------------------------------------------------------------------------------------------
Version="2.55b4"                                    # Current version of VPNMON-R2
                ...
                case "$ConfigSelection" in
                  ...
                  17) # -----------------------------------------------------------------------------------------
                     ...
                     if [ "$UpdateUnbound" == "0" ]; then
                       ...
                       # Download and create the unbound_DNS_via_OVPN.sh file
                       if [ ! -f /jffs/addons/unbound/unbound_DNS_via_OVPN.sh ]; then
