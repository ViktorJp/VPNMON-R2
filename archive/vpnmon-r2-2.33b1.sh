...
# VPNMON-R2 v2.33b1 (VPNMON-R2.SH) is an all-in-one script that is optimized for NordVPN, SurfShark VPN and Perfect Privacy
...
# -------------------------------------------------------------------------------------------------------------------------
Version="2.33b1"                                    # Current version of VPNMON-R2
...
lockcheck () {
  ...
  WAN1OverrideLock=0
  while [ $WAN1Override == "0" ] && [ $wstate0 -ne 2 ] && [ $wstate1 -eq 2 ]
    do
      # clear screen
      clear
      SPIN=15
