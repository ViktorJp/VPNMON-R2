...
# -------------------------------------------------------------------------------------------------------------------------
Version="1.5b3"                                     # Current version of VPNMON-R2
    ...
    if [ -f $CFGPATH ] #Making sure file exists before proceeding
      then
        ...
        if [ "$UseNordVPN" == "1" ]; then
          ...
          echo -e "${CGreen}Using: "$NordVPNCountry
          echo ""
          ...
          echo -e "${CGreen}Using: "$NordVPNLoadReset
          echo ""
        ...
        if promptyn "(Yes/No): "; then
          ...
          echo -e "${CGreen}Using: "$DailyResetTime
        else
          ResetOption=0
